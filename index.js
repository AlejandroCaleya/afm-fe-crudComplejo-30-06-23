...
// 		if (error) throw error;
// 		res.render("editarCategorias", { producto: result[0] });
// 	});
// });
...
// 		if (error) throw error;
// 		res.render("editarFabricantes", { producto: result[0] });
// 	});
// });
...
app.post("/editarproductos/:id", (req, res) => {
	...
	db.query("UPDATE productos SET nombre = ?, precio = ?, stock = ? WHERE id = ?", [nombre, precio, stock], (error, result) => {
		if (error) throw error;
		res.redirect("/listarproductos");
	});
});
...
// 	const id = req.params.id;
// 	const nombre = req.body;
// 	db.query("UPDATE categorias SET nombre = ? WHERE id = ?", nombre, (error, result) => {
// 		if (error) throw error;
// 		res.redirect("/listarcategorias");
// 	});
// });
...
// 	const id = req.params.id;
// 	const nombre = req.body;
// 	db.query("UPDATE fabricantes SET nombre = ? WHERE id = ?", nombre, (error, result) => {
// 		if (error) throw error;
// 		res.redirect("/listarfabricantes");
// 	});
// });
